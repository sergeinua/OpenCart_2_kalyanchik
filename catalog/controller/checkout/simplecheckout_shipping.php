...
class ControllerCheckoutSimpleCheckoutShipping extends SimpleController {
    ...
    public function index() {
        ...
        $sort_order = array();
        //kostil - removing weight signature from the checkout page
        $quote_data['citylink']['quote']['citylink']['title'] = substr( $quote_data['citylink']['quote']['citylink']['title'], 0, strlen($quote_data['citylink']['quote']['citylink']['title']) - 20 );
