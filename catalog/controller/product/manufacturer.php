...
class ControllerProductManufacturer extends Controller {
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			if(isset($manufacturer_info['seo_title']) && $manufacturer_info['seo_title'])
			{
				$this->document->setTitle($manufacturer_info['seo_title']);

			}
			if(isset($manufacturer_info['seo_description']) && $manufacturer_info['seo_description'])
			{
			...
			$data['description'] = $manufacturer_info['man_description'];
