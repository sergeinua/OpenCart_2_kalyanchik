        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <td class="text-center hidden-xs hidden-sm"><?php echo $column_model; ?></td>
...
<small> - <?php echo $option['name']; ?>: <?php echo $option['value']; ?></small>
                <?php } ?></td>
              <td class="text-center hidden-xs hidden-sm"><?php echo $product['model']; ?></td>
              <td class="text-center hidden-xs"><?php echo $product['quantity']; ?></td>
              <td class="text-right hidden-xs hidden-sm"><?php echo $product['price']; ?></td>
              <td class="text-right"><?php echo $product['total']; ?></td>
              <td class="text-right" style="white-space: nowrap;"><?php if ($product['reorder']) { ?>
                <a href="<?php echo $product['reorder']; ?>" data-toggle="tooltip" title="<?php echo $button_reorder; ?>" class="btn btn-success"><i class="fa fa-shopping-cart"></i></a>
                <?php } ?>
