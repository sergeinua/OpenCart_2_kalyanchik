<?php echo $header; ?>
<div class="register-page my-heading ">
<div class="container">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <div class="my-radio">
                <input id="newsletter" type="radio" name="newsletter" value="1" checked="checked">
                <label for="newsletter"><?php echo $text_yes; ?></label>
              </div>

              <div class="my-radio">
                <input id="newsletter" type="radio" name="newsletter" value="0">
                <label for="newsletter"><?php echo $text_no; ?></label>
              </div>

                    <?php } else { ?>
              <div class="my-radio">
                  <input id="newsletter" type="radio" name="newsletter" value="1" />
                  <label for="newsletter"><?php echo $text_yes; ?></label>
              </div>

              <div class="my-radio">
                  <input id="newsletter"  type="radio" name="newsletter" value="0" checked="checked">
                  <label for="newsletter"><?php echo $text_no; ?></label>
              </div>
              <?php } ?>
        ...
        <div class="buttons">
          <div class="pull-right">
            ...
            <?php if ($agree) { ?>
            <input id="agree-checkbox" type="checkbox" name="agree" value="1" checked="checked" />
            <?php } else { ?>
            <input id="agree-checkbox" type="checkbox" name="agree" value="1" />
            <?php } ?>
            <label for="agree-checkbox"><?php echo $text_agree; ?></label>
              </div>
            <div class="pull-right">
