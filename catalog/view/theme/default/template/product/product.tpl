...
<?php if($model): ?>
    ...
    <span style="display:inline-block;transform:translateY(5px)"><?php echo 'Модель: '.$model ?></span>
...
<ul class="list-unstyled product-price">
    ...
    <li>
        ...
        <div class="price-in-li"><span class="price-in-li-div">Цена:</span> <?php echo $price; ?></div>
    ...
    <li>
        ...
        <div class="price-in-li"><span class="price-in-li-div">Цена: </span><?php echo $special; ?></div>
...
<?php } ?>
    ...
    <div class="attr-title">
        ...
        <span style="font-weight: normal;"><?=$stock ?></span>
...
<!--            <li class="delivery-ua">Доставка по Украине</li>-->
            ...
            <li class="delivery-free">
                ...
                <a rel="nofollow" href="/delivery" style="position: relative;">

                    <p class="text-uppercase">Бесплатная доставка</p>

                    <span class="details">Подробнее <i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>
